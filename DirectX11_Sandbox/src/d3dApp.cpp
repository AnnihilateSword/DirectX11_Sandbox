...
bool D3DApp::InitDirect3D()
{
    ...
    HR(dxgiDevice->GetAdapter(dxgiAdapter.GetAddressOf()));  // 获取与之关联的适配器
    HR(dxgiAdapter->GetParent(__uuidof(IDXGIFactory1), reinterpret_cast<void**>(dxgiFactory1.GetAddressOf())));  // 获取父对象，即 DXGI 工厂
